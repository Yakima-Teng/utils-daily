import getWechatRedirectUrl from '../../../src/wechat/getWechatRedirectUrl'

describe('getWechatRedirectUrl', function () {
  it('should return wechat redirect url', function () {
    const appId = 'appId'
    const targetUrl = 'http://www.baidu.com/test#?a=3'
    const wechatRedirectUrl = getWechatRedirectUrl(appId, targetUrl)
  ...
  it('should be able to throw error object with wrong value for parameter `targetUrl`', function () {
    ...
    const anonymousFunction = () => { getWechatRedirectUrl('test', 'test.html') }

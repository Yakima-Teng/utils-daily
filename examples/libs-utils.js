...
(function (global, factory) {
  ...
  function baseIsArrayBuffer(value) {
    return isObjectLike(value) && baseGetTag(value) == arrayBufferTag$3;
  }
  ...
  function baseIsDate(value) {
    return isObjectLike(value) && baseGetTag(value) == dateTag$3;
  }
  ...
  function baseSortedIndexBy(array, value, iteratee, retHighest) {
    ...
    while (low < high) {
      var mid = nativeFloor$2((low + high) / 2),
  ...
  function getFuncName(func) {
    var result = (func.name + ''),
        ...
        length = hasOwnProperty$14.call(realNames, result) ? array.length : 0;
  ...
  function lodash(value) {
    if (isObjectLike(value) && !isArray(value) && !(value instanceof LazyWrapper)) {
      ...
      if (hasOwnProperty$15.call(value, '__wrapped__')) {
  ...
  function reorder(array, indexes) {
    var arrLength = array.length,
        length = nativeMin$3(indexes.length, arrLength),
    ...
    return flatRest(function(funcs) {
      ...
      while (++index < length) {
        ...
        if (data && isLaziable(data[0]) &&
              data[1] == (WRAP_ARY_FLAG$2 | WRAP_CURRY_FLAG$3 | WRAP_PARTIAL_FLAG$2 | WRAP_REARG_FLAG$1) &&
  ...
  function mergeData(data, source) {
    var bitmask = data[1],
        ...
        isCommon = newBitmask < (WRAP_BIND_FLAG$5 | WRAP_BIND_KEY_FLAG$3 | WRAP_ARY_FLAG$3);

    var isCombo =
      ((srcBitmask == WRAP_ARY_FLAG$3) && (bitmask == WRAP_CURRY_FLAG$4)) ||
      ((srcBitmask == WRAP_ARY_FLAG$3) && (bitmask == WRAP_REARG_FLAG$2) && (data[7].length <= source[8])) ||
      ((srcBitmask == (WRAP_ARY_FLAG$3 | WRAP_REARG_FLAG$2)) && (source[7].length <= source[8]) && (bitmask == WRAP_CURRY_FLAG$4));
    ...
    if (srcBitmask & WRAP_ARY_FLAG$3) {
      data[8] = data[8] == null ? source[8] : nativeMin$5(data[8], source[8]);
    }
  ...
  function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
    ...
    if (!length) {
      bitmask &= ~(WRAP_PARTIAL_FLAG$3 | WRAP_PARTIAL_RIGHT_FLAG$2);
    ...
    if (!arity && bitmask & (WRAP_CURRY_FLAG$5 | WRAP_CURRY_RIGHT_FLAG$2)) {
      bitmask &= ~(WRAP_CURRY_FLAG$5 | WRAP_CURRY_RIGHT_FLAG$2);
    }
    if (!bitmask || bitmask == WRAP_BIND_FLAG$6) {
      var result = createBind(func, bitmask, thisArg);
    } else if (bitmask == WRAP_CURRY_FLAG$5 || bitmask == WRAP_CURRY_RIGHT_FLAG$2) {
      result = createCurry(func, bitmask, arity);
    } else if ((bitmask == WRAP_PARTIAL_FLAG$3 || bitmask == (WRAP_BIND_FLAG$6 | WRAP_PARTIAL_FLAG$3)) && !holders.length) {
  ...
  function customDefaultsAssignIn(objValue, srcValue, key, object) {
    if (objValue === undefined ||
        (eq(objValue, objectProto$19[key]) && !hasOwnProperty$16.call(object, key))) {
      return srcValue;
    }
    return objValue;
  }
  ...
  function getView(start, end, transforms) {
    ...
    while (++index < length) {
      ...
      switch (data.type) {
        ...
        case 'take':      end = nativeMin$6(end, start + size); break;
        case 'takeRight': start = nativeMax$6(start, end - size); break;
      }
    }
  ...
  function chunk(array, size, guard) {
    if ((guard ? isIterateeCall(array, size, guard) : size === undefined)) {
      ...
      size = nativeMax$7(toInteger(size), 0);
    }
    var length = array == null ? 0 : array.length;
    if (!length || size < 1) {
      return [];
  ...
  function lastIndexOf(array, value, fromIndex) {
    ...
    if (fromIndex !== undefined) {
      index = toInteger(fromIndex);
      index = index < 0 ? nativeMax$11(length + index, 0) : nativeMin$9(index, length - 1);
    }
    return value === value
  ...
  function ary(func, n, guard) {
    ...
    return createWrap(func, WRAP_ARY_FLAG$4, undefined, undefined, undefined, undefined, n);
  }
  ...
  var assign = createAssigner(function(object, source) {
    ...
    for (var key in source) {
      if (hasOwnProperty$17.call(source, key)) {
  ...
  function flatMapDeep(collection, iteratee) {
    return baseFlatten(map(collection, iteratee), INFINITY$5);
  }
  ...
  function includes(collection, value, fromIndex, guard) {
    ...
    var length = collection.length;
    if (fromIndex < 0) {
      fromIndex = nativeMax$13(length + fromIndex, 0);
    }
  ...
  function curry(func, arity, guard) {
    ...
    var result = createWrap(func, WRAP_CURRY_FLAG$6, undefined, undefined, undefined, undefined, undefined, arity);
  ...
  function debounce(func, wait, options) {
    ...
    if (isObject(options)) {
      ...
      maxWait = maxing ? nativeMax$14(toNumber(options.maxWait) || 0, wait) : maxWait;
    ...
    function remainingWait(time) {
      ...
      return maxing
        ? nativeMin$10(timeWaiting, maxWait - timeSinceLastInvoke)
        : timeWaiting;
    }
  ...
  var defaults = baseRest(function(object, sources) {
    ...
    while (++index < length) {
      ...
      while (++propsIndex < propsLength) {
        ...
        if (value === undefined ||
            (eq(value, objectProto$23[key]) && !hasOwnProperty$20.call(object, key))) {
   ...
   * of values.
   */
  var nativeObjectToString$2 = objectProto$24.toString;
   ...
   * of values.
   */
  var nativeObjectToString$3 = objectProto$25.toString;
  ...
  function toArray(value) {
    ...
    var tag = getTag$1(value),
        func = tag == mapTag$9 ? mapToArray : (tag == setTag$9 ? setToArray : values);
  ...
  function toSafeInteger(value) {
    return value
      ? baseClamp(toInteger(value), -MAX_SAFE_INTEGER$4, MAX_SAFE_INTEGER$4)
      : (value === 0 ? value : 0);
  }
  ...
  var overArgs = castRest(function(func, transforms) {
    ...
    return baseRest(function(args) {
      ...
      var index = -1,
          length = nativeMin$11(args.length, funcsLength);
  ...
  function pad(string, length, chars) {
    ...
    return (
      createPadding(nativeFloor$3(mid), chars) +
      string +
      createPadding(nativeCeil$3(mid), chars)
    );
  }
  ...
  function random(lower, upper, floating) {
    ...
    if (floating || lower % 1 || upper % 1) {
      ...
      return nativeMin$12(lower + (rand * (upper - lower + freeParseFloat('1e-' + ((rand + '').length - 1)))), upper);
    }
  ...
  function spread(func, start) {
    ...
    start = start == null ? 0 : nativeMax$15(toInteger(start), 0);
    return baseRest(function(args) {
  ...
  function times(n, iteratee) {
    ...
    var index = MAX_ARRAY_LENGTH$5,
        length = nativeMin$13(n, MAX_ARRAY_LENGTH$5);
  ...
  var index = {
    ...
    _WeakMap: WeakMap,
    _addMapEntry: addMapEntry,
    _addSetEntry: addSetEntry,
    _apply: apply,
    ...
    _baseWrapperValue: baseWrapperValue,
    _baseXor: baseXor,
    ...
    _createInverter: createInverter,
    _createMathOperation: createMathOperation,
    _createOver: createOver,
    ...
    _lazyClone: lazyClone,
    _lazyReverse: lazyReverse,

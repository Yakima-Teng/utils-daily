...
function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
  ...
  arity = newData[9] = newData[9] === undefined
    ...
    : nativeMax$9(newData[9] - length, 0);
...
cloneableTags[errorTag$3] = cloneableTags[funcTag$2] =
...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (eq(value, objectProto$21[key]) && !hasOwnProperty$18.call(object, key))) {
...
function toSafeInteger(value) {
  return value
    ? baseClamp(toInteger(value), -MAX_SAFE_INTEGER$3, MAX_SAFE_INTEGER$3)
    : (value === 0 ? value : 0);
}
